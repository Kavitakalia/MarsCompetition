...
namespace MarsFramework.Pages
{
    class SignUp
    {
        ...
        [FindsBy(How = How.XPath, Using = "//input[contains(@name,'pass')]")]
        private IWebElement Password { get; set; }

        //Identify Confirm Password Textbox
        [FindsBy(How = How.XPath, Using = "//input[contains(@name,'confirmPass')]")]
        private IWebElement ConfirmPassword { get; set; }

        //Identify Term and Conditions Checkbox
        [FindsBy(How = How.XPath, Using = "//input[contains(@name,'terms')]")]
