    ...
    
{
    internal class Profile
    {
        ...
        [FindsBy(How = How.XPath, Using = "(//i[contains(@class,'right floated outline small write icon')])[2]")]
        private IWebElement AvailabilityHours { get; set; }

        //Click on Earn Target
        [FindsBy(How = How.XPath, Using = "(//i[contains(@class,'right floated outline small write icon')])[3]")]
        private IWebElement Salary { get; set; }

        //Click on Location
        [FindsBy(How = How.XPath, Using = "//strong[text()='Location']")]
        ...
        [FindsBy(How =How.XPath,Using = "(//div[contains(text(),'Add')])[1]")]
        ...
        //Select the Language on Level
        [FindsBy(How = How.XPath, Using = "//select/option[text()='Choose Language Level']")]
        private IWebElement ChooseLang { get; set; }

        //Select the Language option
        [FindsBy(How = How.XPath, Using = "//select/option[@value='Fluent']")]
        private IWebElement ChooseLangOpt { get; set; }

        //Add Language
        [FindsBy(How = How.XPath, Using = "(//div/input[@value='Add'])[1]")]
